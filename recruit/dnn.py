...
opt = optimizers.Adam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-05)
...
#model.add(Dense({{choice([32, 64,126, 256, 512, 1024])}},init='he_normal',input_shape=(train.shape[1],)))
...
# fit network
model.fit(np.array(X_train), np.array(y_train), epochs=200, batch_size=256, validation_data=(np.array(X_valid), np.array(y_valid)),
