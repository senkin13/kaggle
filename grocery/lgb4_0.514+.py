...
def prepare_dataset(t2017, is_train=True):
    X = pd.DataFrame({
        ...
        "var_60_2017": get_timespan(df_2017, t2017, 60, 60).var(axis=1).values,
    ...
    for i in range(7):
        ...
        X['var_20_dow{}_2017'.format(i)] = get_timespan(df_2017, t2017, 140-i, 20, freq='7D').var(axis=1).values
