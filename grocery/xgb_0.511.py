...
print("Training and predicting xgb models...")
...
for i in range(16):
    ...
    bst = xgb.train(
        params, dtrain, MAX_ROUNDS,
        watchlist, early_stopping_rounds=50, verbose_eval=100
    )
...
submission[['id','unit_sales']].to_csv('xgb0113.csv', float_format='%.6f', index=None)
